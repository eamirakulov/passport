          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( isset( $_REQUEST['settings-updated'] ) && $_REQUEST['settings-updated'] == 'true' ) {
              ...
              if ( isset( $layouts['active_layout'] ) ) {
                ...
                $layouts[$layouts['active_layout']] = crmm_encode( serialize( $cool_megamenu ) );
            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<div id="crmm-header-wrap">';
                ...
                echo '<ul id="crmm-header">';
                  ...
                  echo '<li id="crmm-logo">' . apply_filters( 'crmm_header_logo_link', '<a href="http://wordpress.org/extend/plugins/cool-responsive-mega-menu/" target="_blank"></a>', $page['id'] ) . '</li>';
                  
                  echo '<li id="crmm-version"><span>' . apply_filters( 'crmm_header_version_text', 'Cool Megamenu ' . CRMM_VERSION, $page['id'] ) . '</span></li>';
                ...
                /* layouts form */
                if ( $page['id'] == 'crmm_options' && CRMM_SHOW_NEW_LAYOUT == true )
          ...
          foreach( (array) $this->get_the_settings( $page ) as $setting ) {
            ...
            if ( isset( $setting['type'] ) && isset( $input[$setting['id']] ) ) {
              ...
              if ( is_array( $input[$setting['id']] ) && in_array( $setting['type'], array( 'list-item', 'slider' ) ) ) {
                ...
                $settings = isset( $_POST[$setting['id'] . '_settings_array'] ) ? unserialize( crmm_decode( $_POST[$setting['id'] . '_settings_array'] ) ) : array();
