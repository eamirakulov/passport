            ...
            array(
                ...
                'value' => urlencode( json_encode( array(
                    array(
                        'title' => 'Brand image',
                        'url' => '',
                        'image' => PERGO_URI. '/images/brand-1.png',
                    ),
                    array(
                        'title' => 'Brand image',
                        'url' => '',
                        'image' => PERGO_URI. '/images/brand-2.png',
                    ),
                    array(
                        'title' => 'Brand image',
                        'url' => '',
                        'image' => PERGO_URI. '/images/brand-3.png',
                    ),
                    array(
                        'title' => 'Brand image',
                        'url' => '',
                        'image' => PERGO_URI. '/images/brand-4.png',
                    ),
                    array(
                        'title' => 'Brand image',
                        'image' => PERGO_URI. '/images/brand-5.png',
                    ),
                    array(
                        'title' => 'Brand image',
                        'url' => '',
                        'image' => PERGO_URI. '/images/brand-6.png',
                    ),
                ) ) ),
                'params' => array(
                     array(
