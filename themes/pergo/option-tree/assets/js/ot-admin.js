        ...
        if ( window.wp && wp.media ) {
          ...
          window.ot_media_frame.on('select', function() {
            ...
            if ( mime.match(regex) ) {
              ...
              btnContent += '<div class="option-tree-ui-image-wrap"><img src="'+href+'" alt="'+attachment_id+'" /></div>';
          ...
          window.send_to_editor = function(html) {
            ...
            var imgtitle = $(html).find('img').attr('alt');
            ...
            if (href.match(image) && OT_UI.url_exists(href)) {
              ...
              btnContent += '<div class="option-tree-ui-image-wrap"><img src="'+href+'" alt="'+imgtitle+'" /></div>';
    ...
    init_upload_fix: function(elm) {
      ...
      if ( val !== '' && ( typeof src == 'undefined' || src == false ) && OT_UI.url_exists(val) ) {
        ...
        if (val.match(image)) {
          ...
          btnContent += '<div class="option-tree-ui-image-wrap"><img src="'+val+'" alt="'+imgtitle+'" /></div>';
