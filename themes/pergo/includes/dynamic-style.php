...
function pergo__background_css($background, $selector = '', $important = false){  
   $output = '';
   $importance = ( $important )? ' !important' : '';
   if ( !empty( $background ) ) {
        $background_color       = ( isset($background['background-color']) && ($background['background-color'] != '') ) ? 'background-color:'. $background['background-color'] .$importance. ';'."\n" : '';
        $background_image       = ( isset($background['background-image']) && ($background['background-image'] != '') ) ? 'background-image: url('.esc_url($background['background-image']).') '.$importance.';'."\n" : '';
        $background_repeat      = ( isset($background['background-repeat']) && ($background['background-repeat'] != '') ) ? 'background-repeat: '. $background['background-repeat'].$importance. ';'."\n" : '';
        $background_positon     = ( isset($background['background-position']) && ($background['background-position'] != '') ) ? 'background-position:'. $background['background-position'].$importance. ';'."\n" : '';
        $background_attachment  = ( isset($background['background-attachment']) && ($background['background-attachment'] != '') ) ? 'background-attachment:'. $background['background-attachment'].$importance. ';'."\n" : '';
        $background_size        = ( isset($background['background-size']) && ($background['background-size'] != '') ) ? 'background-size: '. $background['background-size']. $importance. ';'."\n" : '';
